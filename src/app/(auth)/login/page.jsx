        ...
        <div className='min-h-screen bg-slate-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8'>
            ...
            <div className='bg-white p-8 border border-slate-100 rounded-3xl shadow-sm w-full max-w-md space-y-6'>
                <div className="text-center">
                    ...
                    <h2 className='font-extrabold text-2xl text-slate-900 mt-6'>Welcome Back</h2>
                    <p className='text-slate-500 text-sm mt-1'>Sign in to explore protected collections</p>
                </div>
